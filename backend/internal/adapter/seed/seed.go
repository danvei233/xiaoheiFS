...
func EnsureSettings(gdb *gorm.DB) error {
	settings := map[string]string{
		...
		"realname_mangzhu_base_url":          "https://e.mangzhuyun.cn",
		"realname_mangzhu_key":               "",
		"realname_mangzhu_auth_mode":         "three_factor",
		"realname_mangzhu_face_provider":     "baidu",
		"realname_mangzhu_timeout_sec":       "10",
		"smtp_host":                          "",
		"smtp_port":                          "",
		"smtp_user":                          "",
		"smtp_pass":                          "",

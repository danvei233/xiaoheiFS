...
URL地址：https://pay.mangzhuyun.com/submit.php
...
| ------------ | -------------- | ---- | ------ | ---------------------------------- | ------------------------- |
| 商户ID       | pid            | 是   | Int    | 1001                               |                           |
| 支付方式     | type           | 否   | String | alipay                             | [支付方式列表](#pay4)     |
...
| 签名字符串   | sign           | 是   | String | 202cb962ac59075b964b07152d234b70   | 签名算法[点此查看](#pay3) |
...
URL地址：https://pay.mangzhuyun.com/mapi.php
...
| ---------------------- | -------------- | ---- | ------ | ---------------------------------- | ------------------------- |
| 商户ID                 | pid            | 是   | Int    | 1001                               |                           |
| 支付方式               | type           | 是   | String | alipay                             | [支付方式列表](#pay4)     |
| 商户订单号             | out\_trade\_no | 是   | String | 20160806151343349                  |                           |
| 异步通知地址           | notify\_url    | 是   | String | http://www.pay.com/notify\_url.php | 服务器异步通知地址        |
...
| 支付跳转url   | payurl    | String | https://pay.mangzhuyun.com/pay/wxpay/202010903/ | 如果返回该字段，则直接跳转到该url支付                   |
...
| ------------ | -------------- | ---- | ------ | -------------------------------- | ------------------------- |
| 商户ID       | pid            | 是   | Int    | 1001                             |                           |
| 易支付订单号 | trade\_no      | 是   | String | 20160806151343349021             | 芒竹计费平台订单号        |
...
URL地址：https://pay.mangzhuyun.com/api.php?act=query&pid={商户ID}&key={商户密钥}
...
URL地址：https://pay.mangzhuyun.com/api.php?act=settle&pid={商户ID}&key={商户密钥}
...
URL地址：https://pay.mangzhuyun.com/api.php?act=order&pid={商户ID}&key={商户密钥}&out\_trade\_no={商户订单号}
...
URL地址：https://pay.mangzhuyun.com/api.php?act=orders&pid={商户ID}&key={商户密钥}
...
URL地址：https://pay.mangzhuyun.com/api.php?act=refund
